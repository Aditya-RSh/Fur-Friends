...
<body>
    ...
    <section class="section">
        <h2>Bring Home a Friend FurEver </h2>
        <p>
            Adopting a pet from FurFriends means more than just bringing home a new friend; it means giving a deserving animal a second chance at happiness. Each of our pets has a unique story, and we're here to help you find the one that best fits into your life and heart.<br>
            By choosing to adopt, you're not only saving a life but also making a positive impact on your community. Our adoption process is designed to be supportive and straightforward, ensuring that both you and your new furry friend have a smooth transition into your new life together.
            Explore our available pets today and discover the joy of giving a FurFriend a loving home. Together, we can make a difference, one paw at a time.
        </p>
    </section>
    ...
    <div class="adoption-list">
        <div class="pet-card">
            ...
            <p>Age: 3 years</p>
            <a href="#" class="adopt-link">Adopt Tiger</a>
        </div>
        <div class="pet-card">
            ...
            <p>Age: 2 years</p>
            <a href="#" class="adopt-link">Adopt Whiskers</a>
        </div>
        <div class="pet-card">
            ...
            <p>Age: 4 years</p>
            <a href="#" class="adopt-link">Adopt Max</a>
        </div>
        <div class="pet-card">
            ...
            <p>Age: 4 years</p>
            <a href="#" class="adopt-link">Adopt Bub</a>
        </div>
        <div class="pet-card">
            ...
            <p>Age: 2 years</p>
            <a href="#" class="adopt-link">Adopt Pinky</a>
        </div>
        <div class="pet-card">
            ...
            <p>Age: 4 years</p>
            <a href="#" class="adopt-link">Adopt Dodo</a>
        </div>
        <div class="pet-card">
            ...
            <p>Age: 4 years</p>
            <a href="#" class="adopt-link">Adopt Oggy</a>
        </div>
        <div class="pet-card">
            ...
            <p>Breed: German Shepherd</p>
            <p>Age: 4 years</p>
            <a href="#" class="adopt-link">Adopt Jackie</a>
        </div>
        <!--to add more cards-->
    </div>
