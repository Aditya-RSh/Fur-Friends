...
<body>
    ...
    <div class="join-options">
        <div class="option">
            ...
            <a href="https://google.form/link/volunteer" class="join-link">Join Us as Volunteer</a>
        </div>
        <div class="option">
            <h3>As Hospital/Vet</h3>
            <p>
                Collaborate with us to provide the best care for rescued animals. We are looking for hospitals and 
                veterinarians to join our network, offering medical services and support for our furry friends in need.
            </p>
            <a href="https://google.form/link/hospital" class="join-link">Join Our Network</a>
        </div>
    </div>
